...
| target_customer | cross_border_ecommerce_seller / goods_trade / service_trade | 是 | 目标客户 |
...
| trend_jacking | 热点借势 |
| customer_case | 客户案例 |
| cross_border_ecommerce_seller | 跨境电商卖家 |
| goods_trade | 货物贸易 |
| service_trade | 服务贸易 |
| fast_settlement | 到账快 |
